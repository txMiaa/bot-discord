...
// 🎯 DAR CARGO (com correção de erro)
client.on("messageReactionAdd", async (reaction, user) => {
  ...
  if (idadeRoles.includes(roleId)) {
    await member.roles.remove(idadeRoles);
  }

  if (corRoles.includes(roleId)) {
    await member.roles.remove(corRoles);
  }
